...
async def redis_decode(encode_str: str, execution_model: pydantic.BaseModel) -> pydantic.BaseModel:
    '''checks json on the transmitted model
    Returns:
       BaseModel -> type=execution_model 
    '''
    try:
